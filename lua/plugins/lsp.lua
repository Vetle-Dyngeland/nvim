return {
    ...
    config = function()
        ...
        lsp.on_attach(function(_, bufnr)
            ...
            map("n", "gn", function() vim.diagnostic.goto_next() end, opts("Go to next diagnostic"))
            map("n", "gN", function() vim.diagnostic.goto_prev() end, opts("Go to previous diagnostic"))
